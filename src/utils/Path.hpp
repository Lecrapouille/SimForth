...
public:
  ...
  //! \brief Save temporary the path of currently loading SimForthMap
  //! file. The goal of the stack is to avoid to SimForth to have path
  //! conflict with two loaded SimForthMap files.
...
protected:
  ...
  //! when loading a SimForth file: this allows to traverse its
  //! resources (a SimForth file is a zip file containing directories
  //! and files). A stack is usefull when loading a SimForth file that
  //! loads another SimForth file.)
